...
${nuget_cmd} install src/Blockfrost.Api/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Blockfrost.Api.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Blockfrost.Api.dll \
-recurse:'src/Blockfrost.Api/*.cs' \
-doc:bin/Blockfrost.Api.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Blockfrost.Api.dll was created successfully"
fi
