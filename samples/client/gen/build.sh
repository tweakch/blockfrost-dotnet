...
${nuget_cmd} install src/Blockfrost.Api.Gen/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Blockfrost.Api.Gen.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Blockfrost.Api.Gen.dll \
-recurse:'src/Blockfrost.Api.Gen/*.cs' \
-doc:bin/Blockfrost.Api.Gen.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Blockfrost.Api.Gen.dll was created successfully"
fi
