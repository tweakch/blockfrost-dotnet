        ...
        public bool Equals(AccountContent input)
        {
            ...
            return 
                (
                    ...
                    (this.StakeAddress != null && this.StakeAddress.Equals(input.StakeAddress))
                ) && 
                (
                    this.Active == input.Active ||
                    (this.Active != null && this.Active.Equals(input.Active))
                ) && 
                (
                ...
                (
                    ...
                    (this.ControlledAmount != null && this.ControlledAmount.Equals(input.ControlledAmount))
                ) && 
                (
                    this.RewardsSum == input.RewardsSum ||
                    (this.RewardsSum != null && this.RewardsSum.Equals(input.RewardsSum))
                ) && 
                (
                    this.WithdrawalsSum == input.WithdrawalsSum ||
                    (this.WithdrawalsSum != null && this.WithdrawalsSum.Equals(input.WithdrawalsSum))
                ) && 
                (
                    this.ReservesSum == input.ReservesSum ||
                    (this.ReservesSum != null && this.ReservesSum.Equals(input.ReservesSum))
                ) && 
                (
                    this.TreasurySum == input.TreasurySum ||
                    (this.TreasurySum != null && this.TreasurySum.Equals(input.TreasurySum))
                ) && 
                (
                    this.WithdrawableAmount == input.WithdrawableAmount ||
                    (this.WithdrawableAmount != null && this.WithdrawableAmount.Equals(input.WithdrawableAmount))
                ) && 
                (
