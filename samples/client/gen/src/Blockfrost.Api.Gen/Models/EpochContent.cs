        ...
        public bool Equals(EpochContent input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.FirstBlockTime != null && this.FirstBlockTime.Equals(input.FirstBlockTime))
                ) && 
                (
                    this.LastBlockTime == input.LastBlockTime ||
                    (this.LastBlockTime != null && this.LastBlockTime.Equals(input.LastBlockTime))
                ) && 
                (
                    this.BlockCount == input.BlockCount ||
                    (this.BlockCount != null && this.BlockCount.Equals(input.BlockCount))
                ) && 
                (
