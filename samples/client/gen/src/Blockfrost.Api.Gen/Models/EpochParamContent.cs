        ...
        public bool Equals(EpochParamContent input)
        {
            ...
            return 
                (
                    ...
                    (this.Epoch != null && this.Epoch.Equals(input.Epoch))
                ) && 
                (
                    this.MinFeeA == input.MinFeeA ||
                    (this.MinFeeA != null && this.MinFeeA.Equals(input.MinFeeA))
                ) && 
                (
                    this.MinFeeB == input.MinFeeB ||
                    (this.MinFeeB != null && this.MinFeeB.Equals(input.MinFeeB))
                ) && 
                (
                    this.MaxBlockSize == input.MaxBlockSize ||
                    (this.MaxBlockSize != null && this.MaxBlockSize.Equals(input.MaxBlockSize))
                ) && 
                (
                    this.MaxTxSize == input.MaxTxSize ||
                    (this.MaxTxSize != null && this.MaxTxSize.Equals(input.MaxTxSize))
                ) && 
                (
                    this.MaxBlockHeaderSize == input.MaxBlockHeaderSize ||
                    (this.MaxBlockHeaderSize != null && this.MaxBlockHeaderSize.Equals(input.MaxBlockHeaderSize))
                ) && 
                (
                    this.KeyDeposit == input.KeyDeposit ||
                    (this.KeyDeposit != null && this.KeyDeposit.Equals(input.KeyDeposit))
                ) && 
                (
                    this.PoolDeposit == input.PoolDeposit ||
                    (this.PoolDeposit != null && this.PoolDeposit.Equals(input.PoolDeposit))
                ) && 
                (
                    this.EMax == input.EMax ||
                    (this.EMax != null && this.EMax.Equals(input.EMax))
                ) && 
                (
                    this.NOpt == input.NOpt ||
                    (this.NOpt != null && this.NOpt.Equals(input.NOpt))
                ) && 
                (
                    this.A0 == input.A0 ||
                    (this.A0 != null && this.A0.Equals(input.A0))
                ) && 
                (
                    this.Rho == input.Rho ||
                    (this.Rho != null && this.Rho.Equals(input.Rho))
                ) && 
                (
                    this.Tau == input.Tau ||
                    (this.Tau != null && this.Tau.Equals(input.Tau))
                ) && 
                (
                    this.DecentralisationParam == input.DecentralisationParam ||
                    (this.DecentralisationParam != null && this.DecentralisationParam.Equals(input.DecentralisationParam))
                ) && 
                (
                    this.ExtraEntropy == input.ExtraEntropy ||
                    (this.ExtraEntropy != null && this.ExtraEntropy.Equals(input.ExtraEntropy))
                ) && 
                (
                    this.ProtocolMajorVer == input.ProtocolMajorVer ||
                    (this.ProtocolMajorVer != null && this.ProtocolMajorVer.Equals(input.ProtocolMajorVer))
                ) && 
                (
                    this.ProtocolMinorVer == input.ProtocolMinorVer ||
                    (this.ProtocolMinorVer != null && this.ProtocolMinorVer.Equals(input.ProtocolMinorVer))
                ) && 
                (
                    this.MinUtxo == input.MinUtxo ||
                    (this.MinUtxo != null && this.MinUtxo.Equals(input.MinUtxo))
                ) && 
                (
                    this.MinPoolCost == input.MinPoolCost ||
                    (this.MinPoolCost != null && this.MinPoolCost.Equals(input.MinPoolCost))
                ) && 
                (
                    this.Nonce == input.Nonce ||
                    (this.Nonce != null && this.Nonce.Equals(input.Nonce))
                );
        }
