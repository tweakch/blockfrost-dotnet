        ...
        public bool Equals(Asset input)
        {
            ...
            return 
                (
                    ...
                    (this._Asset != null && this._Asset.Equals(input._Asset))
                ) && 
                (
                    this.PolicyId == input.PolicyId ||
                    (this.PolicyId != null && this.PolicyId.Equals(input.PolicyId))
                ) && 
                (
                    this.AssetName == input.AssetName ||
                    (this.AssetName != null && this.AssetName.Equals(input.AssetName))
                ) && 
                (
                ...
                (
                    ...
                    (this.Quantity != null && this.Quantity.Equals(input.Quantity))
                ) && 
                (
                    this.InitialMintTxHash == input.InitialMintTxHash ||
                    (this.InitialMintTxHash != null && this.InitialMintTxHash.Equals(input.InitialMintTxHash))
                ) && 
                (
                    this.MintOrBurnCount == input.MintOrBurnCount ||
                    (this.MintOrBurnCount != null && this.MintOrBurnCount.Equals(input.MintOrBurnCount))
                ) && 
                (
                    this.OnchainMetadata == input.OnchainMetadata ||
                    (this.OnchainMetadata != null && this.OnchainMetadata.Equals(input.OnchainMetadata))
                ) && 
                (
