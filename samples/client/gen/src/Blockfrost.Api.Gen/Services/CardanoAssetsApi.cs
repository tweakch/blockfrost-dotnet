...
namespace Blockfrost.Api.Gen.Services
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class CardanoAssetsApi : ABlockfrostService, ICardanoAssetsApi
    {
        public CardanoAssetsApi(System.Net.Http.HttpClient httpClient) : base(httpClient)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public CardanoAssetsApi(String basePath) : base(basePath){}

        /// <summary>
        /// Initializes a new instance of the <see cref="CardanoAssetsApi"/> class
        /// </summary>
        /// <returns></returns>
        public CardanoAssetsApi() : base(Blockfrost.Api.Gen.Client.Configuration.Default) { }
        ...
        /// <returns></returns>
        public CardanoAssetsApi(Blockfrost.Api.Gen.Client.Configuration configuration = null) : base(configuration)
        {
        }
