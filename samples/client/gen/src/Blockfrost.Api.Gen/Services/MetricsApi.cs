...
namespace Blockfrost.Api.Gen.Services
{
    ...
    /// </summary>
        public interface IMetricsApi : IBlockfrostService
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class MetricsApi : ABlockfrostService, IMetricsApi
    {
        public MetricsApi(System.Net.Http.HttpClient httpClient) : base(httpClient)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public MetricsApi(String basePath) : base(basePath){}

        /// <summary>
        /// Initializes a new instance of the <see cref="MetricsApi"/> class
        /// </summary>
        /// <returns></returns>
        public MetricsApi() : base(Blockfrost.Api.Gen.Client.Configuration.Default) { }
        ...
        /// <returns></returns>
        public MetricsApi(Blockfrost.Api.Gen.Client.Configuration configuration = null) : base(configuration)
        {
        }
