...
namespace Blockfrost.Api.Gen.Services
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class NutLinkApi : ABlockfrostService, INutLinkApi
    {
        public NutLinkApi(System.Net.Http.HttpClient httpClient) : base(httpClient)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public NutLinkApi(String basePath) : base(basePath){}

        /// <summary>
        /// Initializes a new instance of the <see cref="NutLinkApi"/> class
        /// </summary>
        /// <returns></returns>
        public NutLinkApi() : base(Blockfrost.Api.Gen.Client.Configuration.Default) { }
        ...
        /// <returns></returns>
        public NutLinkApi(Blockfrost.Api.Gen.Client.Configuration configuration = null) : base(configuration)
        {
        }
