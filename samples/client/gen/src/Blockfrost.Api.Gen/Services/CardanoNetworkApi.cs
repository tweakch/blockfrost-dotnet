...
namespace Blockfrost.Api.Gen.Services
{
    ...
    /// </summary>
        public interface ICardanoNetworkApi : IBlockfrostService
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class CardanoNetworkApi : ABlockfrostService, ICardanoNetworkApi
    {
        public CardanoNetworkApi(System.Net.Http.HttpClient httpClient) : base(httpClient)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public CardanoNetworkApi(String basePath) : base(basePath){}

        /// <summary>
        /// Initializes a new instance of the <see cref="CardanoNetworkApi"/> class
        /// </summary>
        /// <returns></returns>
        public CardanoNetworkApi() : base(Blockfrost.Api.Gen.Client.Configuration.Default) { }
        ...
        /// <returns></returns>
        public CardanoNetworkApi(Blockfrost.Api.Gen.Client.Configuration configuration = null) : base(configuration)
        {
        }
