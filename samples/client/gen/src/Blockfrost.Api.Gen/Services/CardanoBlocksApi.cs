...
namespace Blockfrost.Api.Gen.Services
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class CardanoBlocksApi : ABlockfrostService, ICardanoBlocksApi
    {
        public CardanoBlocksApi(System.Net.Http.HttpClient httpClient) : base(httpClient)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public CardanoBlocksApi(String basePath) : base(basePath){}

        /// <summary>
        /// Initializes a new instance of the <see cref="CardanoBlocksApi"/> class
        /// </summary>
        /// <returns></returns>
        public CardanoBlocksApi() : base(Blockfrost.Api.Gen.Client.Configuration.Default) { }
        ...
        /// <returns></returns>
        public CardanoBlocksApi(Blockfrost.Api.Gen.Client.Configuration configuration = null) : base(configuration)
        {
        }
