...
namespace Blockfrost.Api.Gen.Services
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class IPFSAddApi : ABlockfrostService, IIPFSAddApi
    {
        public IPFSAddApi(System.Net.Http.HttpClient httpClient) : base(httpClient)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public IPFSAddApi(String basePath) : base(basePath){}

        /// <summary>
        /// Initializes a new instance of the <see cref="IPFSAddApi"/> class
        /// </summary>
        /// <returns></returns>
        public IPFSAddApi() : base(Blockfrost.Api.Gen.Client.Configuration.Default) { }
        ...
        /// <returns></returns>
        public IPFSAddApi(Blockfrost.Api.Gen.Client.Configuration configuration = null) : base(configuration)
        {
        }
