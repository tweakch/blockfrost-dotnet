...
namespace Blockfrost.Api.Gen.Services
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class CardanoAddressesApi : ABlockfrostService, ICardanoAddressesApi
    {
        public CardanoAddressesApi(System.Net.Http.HttpClient httpClient) : base(httpClient)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public CardanoAddressesApi(String basePath) : base(basePath){}

        /// <summary>
        /// Initializes a new instance of the <see cref="CardanoAddressesApi"/> class
        /// </summary>
        /// <returns></returns>
        public CardanoAddressesApi() : base(Blockfrost.Api.Gen.Client.Configuration.Default) { }
        ...
        /// <returns></returns>
        public CardanoAddressesApi(Blockfrost.Api.Gen.Client.Configuration configuration = null) : base(configuration)
        {
        }
