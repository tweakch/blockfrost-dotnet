...
namespace Blockfrost.Api.Gen.Services
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class CardanoLedgerApi : ABlockfrostService, ICardanoLedgerApi
    {
        public CardanoLedgerApi(System.Net.Http.HttpClient httpClient) : base(httpClient)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public CardanoLedgerApi(String basePath) : base(basePath){}

        /// <summary>
        /// Initializes a new instance of the <see cref="CardanoLedgerApi"/> class
        /// </summary>
        /// <returns></returns>
        public CardanoLedgerApi() : base(Blockfrost.Api.Gen.Client.Configuration.Default) { }
        ...
        /// <returns></returns>
        public CardanoLedgerApi(Blockfrost.Api.Gen.Client.Configuration configuration = null) : base(configuration)
        {
        }
