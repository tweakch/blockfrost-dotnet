...
namespace Blockfrost.Api.Gen.Services
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class HealthApi : ABlockfrostService, IHealthApi
    {
        public HealthApi(System.Net.Http.HttpClient httpClient) : base(httpClient)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public HealthApi(String basePath) : base(basePath){}

        /// <summary>
        /// Initializes a new instance of the <see cref="HealthApi"/> class
        /// </summary>
        /// <returns></returns>
        public HealthApi() : base(Blockfrost.Api.Gen.Client.Configuration.Default) { }
        ...
        /// <returns></returns>
        public HealthApi(Blockfrost.Api.Gen.Client.Configuration configuration = null) : base(configuration)
        {
        }
